            ...
            <div class="bg-white lg:w-5/12 md:6/12 w-10/12 shadow-3xl">
                ...
                <form class="p-12 md:px-20" onSubmit={handleLoginSubmit}>
                    <div class="flex items-center text-lg mb-6 md:mb-8">
                        ...
                        <input class="bg-gray-200 pl-12 py-2 md:py-4 focus:outline-none w-full" type="number" name="phoneNumber" placeholder="Phone Number" required onChange={handleInputChange} />
                    </div>
                    <div class="flex items-center text-lg mb-6 md:mb-8">
